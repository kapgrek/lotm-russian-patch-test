...
* **`tools/`** — Набор автоматизированных утилит:
  * `ShardCompiler.ps1` — Компилятор/распределитель строк по 1024 шардам на базе алгоритма FNV-1a.
  * `StringExtractor.ps1` — Утилита извлечения текстов из английских шардов в удобные JSON/CSV.
